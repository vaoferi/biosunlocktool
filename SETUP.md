...
- ✅ `locales/<locale>/` — місце мовних копій; `pl-PL` тепер містить повний canonical-layout із польським UI та Poland-атмосферою, `de/af` ще залишаються legacy-заглушками, а `in` використовує English canonical з India-атмосферою;
